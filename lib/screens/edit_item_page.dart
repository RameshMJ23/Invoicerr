...
class _EditPageState extends State<EditPage> {
  ...
  void initState() {
    ...
    itemNumberController.text = widget.itemModel.numberOfItems.toString();
    itemCostController.text = widget.itemModel.costPerUnit.toString();
    taxController.text = widget.itemModel.tax.toString();
    discountController.text = widget.itemModel.discount != null
                  ...
                  onPressed: (){
                    ...
                    if(formKey.currentState!.validate()){
                      ...
                      if(widget.model != null){
                        List<ItemModel> itemList = widget.model!.items;
                        itemList[widget.index] = newModel;
                        ...
                        BlocProvider.of<AddItemCubit>(context).editItem(
                            ItemModel(
                                itemName: itemNameController.text,
                                costPerUnit: double.parse(itemCostController.text),
                                tax: double.parse(taxController.text.isEmpty ? "0.0" : taxController.text),
